		    	...
		    	<div class="row" style="height: 100%;">
					...
					<#else >
                        <span class="col-xs-12" id="loginOrRegSpan" style="font-size: 14px;">
		          			<a href="${basepath}/account/login">登陆</a>|<a href="${basepath}/account/register">注册</a>|<a href="${basepath}/manage/user/registerUser">我要卖商品</a>
		          		</span>
					</#if>
...
<div class="navbar navbar-default" style="margin-bottom: 15px;z-index: 111">
      <div class="container">
        <div class="navbar-header col-xs-3" style="text-align: center;" id="navbar-header">
			  <a class="navbar-brand" href="${systemSetting().www}/index" style="font-weight: bold;margin-left: 5px;">全部商品</a>
	          ...
	          <ul class="nav navbar-nav" >
	          		...
	          		<!-- 首页 -->
						<#if selectMenu=="0">
                            ...
                            <li><a target="_blank" href="${systemSetting().www}/manage/user/login"><b>管理员登录</b></a></li>
						<#else>
		          ...
		          <ul class="nav navbar-nav navbar-right" style="display: block;">
					...
					<!--<li class="${(selectMenu=="activity")?string("active","")}">
					 ...
					 <!-- 新闻动态-->
					 <li><a href="${basepath}/news/list.html" >
							<b>新闻动态</b></a>
					 </li>
