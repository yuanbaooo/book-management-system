...
public class UserAction extends BaseController<User> {
    ...
    public String registerUser(@ModelAttribute("e") User e, ModelMap model){
...
//			}
	...
	public String register(HttpServletRequest request, @ModelAttribute("e") User user, RedirectAttributes flushAttrs) throws Exception {
		return save1(user, flushAttrs);
	}
    
    private String save1(User e, RedirectAttributes flushAttrs) throws Exception {
		...
		if(StringUtils.isBlank(e.getPassword()) || StringUtils.isBlank(e.getNewpassword2())){
			...
			return "redirect:/manage/system/user/registerUser";
		}
